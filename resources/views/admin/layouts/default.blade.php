...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="{{asset('logo.png')}}" alt="Myntra Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Myntra</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2025 <a href="https://myntra.com">Myntra.in</a>.</strong>
    All rights reserved.
